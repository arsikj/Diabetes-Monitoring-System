					...
					<div class="card-body">
						<form class="form-signin" method="POST" id="form" action="${pageContext.request.contextPath}/signup">
							...
							<p class="text-center register-margin">
								<a class="card-link form-control-sm form-text" href="${pageContext.request.contextPath}/login">Login here</a>
							</p>
							<p class="text-center margin_top5 color_red">${message}</p>
						</form>
					</div>
				</div>
			</div>
